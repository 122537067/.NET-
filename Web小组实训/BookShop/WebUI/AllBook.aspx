<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AllBook.aspx.cs" Inherits="BookShop.WebUI.AllBook" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ThisContent" runat="server">
    <div id="msg" runat="server" class="title2"><span class="fl"></span></div>
    ...
    <div class="list-right fr">
        <ul class="pic-list">
            <asp:Repeater ID="AllBooksShow" runat="server">
                <ItemTemplate>
                    <li>
                        <a href="BookContentShow.aspx?ISBN=<%#DataBinder.Eval(Container.DataItem, "ISBN")%>" title="作者：<%#DataBinder.Eval(Container.DataItem, "Writer")%>">
